...
class E:
    ...
    def result(self, MainWindow,Sid):
        ...
        def acc(self) :
             ...
             insert.big_2(Sid,name,address,gender,dob,age,email,contact,course,course_id,year,ssc,cet,hsc,jee,diploma,sem_1,sem_2,sem_3,sem_4,sem_5,sem_6,sem_7,sem_8);
             msg=QMessageBox()
